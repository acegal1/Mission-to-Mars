...
# Convert teh browser html to a soup object
html = browser.html
...
# #JPL Space Images Featured Image.  Scrape the featured image from another Mars website
...
# # MARS FACTS - scraping from tables 
